...
#define ROBOT_TOF_FAILURE_LED_DIAG_ENABLE 0U

/* Set to 1U to try one ToF recovery during an already-running edge escape. */
#define ROBOT_TOF_EDGE_ESCAPE_RECOVERY_ENABLE 1U

#define ROBOT_ATTACK_PWM 1750
#define ROBOT_TRACK_PWM 450
#define ROBOT_SEARCH_PWM 350
#define ROBOT_EDGE_ESCAPE_PWM 600

#define LINE_SENSOR_EDGE_THRESHOLD 450U
#define OPPONENT_DETECT_DISTANCE_MM 300U
#define OPPONENT_TRACK_TIMEOUT_MS 25U //prev 25U
#define OPPONENT_FRONT_LATCH_MS 10U
#define OPPONENT_ATTACK_HOLD_MS 1500U
#define OPPONENT_TRACK_COOLDOWN_MS 5U
#define OPPONENT_SIDE_CROSS_ATTACK_WINDOW_MS 250U
...
#define ROBOT_GAME_MODE_SELECTOR_ENABLE 1U
