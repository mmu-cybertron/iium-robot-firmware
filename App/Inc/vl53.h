...
// 7 bit address after address change
#define VL53_ADDR_1 0x30
#define VL53_ADDR_2 0x31

// STM32 HAL functions takes in shifted address
#define VL53_ADDR_1_8BIT (VL53_ADDR_1 << 1)
#define VL53_ADDR_2_8BIT (VL53_ADDR_2 << 1)
