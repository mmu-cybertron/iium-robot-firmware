...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = FRONT_IR_Pin|RIGHT_IR_Pin|GPIO_PIN_4|GPIO_PIN_5
                          |GPIO_PIN_6|LEFT_IR_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, FRONT_IR_Pin|RIGHT_IR_Pin|GPIO_PIN_4|GPIO_PIN_5
                          |GPIO_PIN_6|LEFT_IR_Pin);
